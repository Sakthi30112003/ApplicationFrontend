...
export class DashboardComponent {
  ...
  this.showTable = !this.showTable;
   ...
   loadTable() {
    this.http.get<any[]>('https://applicationbackend-cpazegbufnhaenae.canadacentral-01.azurewebsites.net/api/Employees') // Use your endpoint
      .subscribe(data => {
        this.tableData = data;
